<template>
  <div>
    <div class="row">
      <router-link to="/store-supplier" class="btn btn-primary ml-3">Add Supplier</router-link>
    </div>
    <br>
    ...
    <div class="row">
      <div class="col-lg-12 mb-4">
        ...
        <pagination :data="suppliers" @pagination-change-page="getResults" class="mt-4 float-right"></pagination>
    ...
    deleteSupplier(id){
      this.$swal.fire({
        ...
        if (result.isConfirmed) {
          this.$axios.delete('http://127.0.0.1:8000/api/supplier/'+ id)
              .then(() => {
