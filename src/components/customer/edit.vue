            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form class="user" @submit.prevent="customerUpdate" enctype="multipart/form-data" novalidate>`
                      ...
                      <div class="form-row">
                        <div class="col-md-6">
                          ...
                          <select class="form-control" id="exampleFormControlSelect1" v-model="form.status.status_id">
                            <option v-for="(key, status) in this.$parent.configuration.customer.status" :key="key" :value="key" :selected="form.status.status_id === key"> {{ status }}</option>
...
export default {
  ...
  methods:{
    ...
    customerUpdate(){
      ...
      this.$axios.put('http://127.0.0.1:8000/api/customer/'+ id, info)
          .then(() => {
  ...
  created(){
    ...
    let id = this.$route.params.id
    this.$axios.get('http://127.0.0.1:8000/api/customer/' + id)
